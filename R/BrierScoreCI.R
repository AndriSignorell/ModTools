...
BrierScoreCI <- function(object, conf.level = 0.95, sides = c("two.sided", "left", "right"), ...){
  UseMethod("BrierScoreCI")
}


BrierScoreCI.default <- function(object, conf.level = 0.95, sides = c("two.sided", "left", "right"), ...)
  .NotThere(object)


BrierScoreCI.glm <- function(object, conf.level = 0.95, sides = c("two.sided", "left", "right"), ...){
